...
public:
  ...
  //! which selects the digital pin that turns the laser on/off.
  Laser(int laserPinR, int laserPinG, int laserPinB);
  ...
  void setPWM(byte red, byte green, byte blue);
...
private:
  ...
  bool _laserColorG;
  bool _laserColorB;
  byte _laserBrightnessR;
  byte _laserBrightnessG;
  byte _laserBrightnessB;
