...
public:
  ...
  // DK Add:
  static void drawLineRotated(unsigned short posX1, unsigned short posY1, unsigned short posX2, unsigned short posY2, long centerX, long centerY, int angle, bool turnOffLaserWhenDone);
  static void drawDotRotated(unsigned short posX1, unsigned short posY1, unsigned short strength, long centerX, long centerY, int angle);
